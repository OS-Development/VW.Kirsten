...
void initialize_menus()
{
	...
	view_listener_t::addMenu(new LLObjectGetUUID(), "Avatar.GetUUID"); // KL actually pull primary ID of whats actually selected
	...
	view_listener_t::addMenu(new LLObjectGetUUID(), "Object.GetUUID"); // KL same routine as for avatar.getUUID but named Object for object menus :)
